...
namespace GenericUnitOfWorkAndRepository.Test
{
    [TestClass]
    public class GenericRepositoryTest
    {
        public const string FileName = "test2.db";
        public const string ConnectionString = "Data Source="+FileName;
        ...
        private void InitializeDb()
        {
            ...
            {
                connection.Execute("CREATE TABLE TestModelClass (Id integer primary key autoincrement not null, Name nvarchar(100) not null, Created DateTime null, LastModified DateTime null) ");
            }
        }
        ...
        private GenericRepository<TestModelClass> PrepareDataAndGetRepository()
        {
            using(var connection = ConnectionFactoryInTest.GetConnection())
            {
                connection.Execute(@"insert into TestModelClass (Name, Created, LastModified) values (@Name, @Created, @LastModified)", _list.ToArray());
            }            
